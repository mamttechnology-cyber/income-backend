...
export const authService = {
  ...
  async forgotPassword(email: string) {
    ...
    const resetLink = `${process.env.FRONTEND_URL || "http://localhost:5173" || "https://income-fronend-az8pom6hb-mamttechnology-2682s-projects.vercel.app"}/reset-password?token=${token}`;
